    ...
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            bundles.Add(new StyleBundle("~/Bundles/css")
                ...
                .Include("~/Content/datatables.net-bs/css/dataTables.bootstrap.min.css"));
            ...
            bundles.Add(new ScriptBundle("~/Bundles/datatable")
                .Include("~/Content/datatables.net/js/jquery.dataTables.min.js")
                .Include("~/Content/datatables.net-bs/js/dataTables.bootstrap.min.js"));
